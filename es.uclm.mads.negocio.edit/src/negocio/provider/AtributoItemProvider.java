...
/**
 * This is the item provider adapter for a {@link negocio.Atributo} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AtributoItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCardinalidadPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 NegocioPackage.Literals.ATRIBUTO__NOMBRE,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Cardinalidad feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCardinalidadPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Atributo_cardinalidad_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Atributo_cardinalidad_feature", "_UI_Atributo_type"),
				 NegocioPackage.Literals.ATRIBUTO__CARDINALIDAD,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
