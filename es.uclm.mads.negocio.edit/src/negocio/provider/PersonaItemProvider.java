...
/**
 * This is the item provider adapter for a {@link negocio.Persona} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Persona_documentos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Persona_documentos_feature", "_UI_Persona_type"),
				 NegocioPackage.Literals.PERSONA__DOCUMENTOS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPagosPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Persona_pagos_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Persona_pagos_feature", "_UI_Persona_type"),
				 NegocioPackage.Literals.PERSONA__PAGOS,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTipoPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Persona_tipo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Persona_tipo_feature", "_UI_Persona_type"),
				 NegocioPackage.Literals.PERSONA__TIPO,
				 true,
				 false,
				 false,
