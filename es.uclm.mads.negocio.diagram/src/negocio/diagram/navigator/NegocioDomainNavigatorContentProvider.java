 ...
 * @generated
 */
public class NegocioDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public NegocioDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof NegocioDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((NegocioDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new NegocioDomainNavigatorItem((EObject) objects[i],
