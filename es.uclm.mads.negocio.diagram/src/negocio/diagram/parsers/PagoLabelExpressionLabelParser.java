package negocio.diagram.parsers;
 ...
 * @generated
 */
public class PagoLabelExpressionLabelParser extends ExpressionLabelParserBase {
	/**
	 * @generated
	 */
	public PagoLabelExpressionLabelParser() {
	}
	...
	protected String getExpressionBody() {
		return NegocioOCLFactory.getExpression(3,
				NegocioPackage.eINSTANCE.getPago(), null).body();
	}
