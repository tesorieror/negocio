 ...
 * @generated
 */
public abstract class NegocioAbstractExpression {
	...
	protected void setStatus(int severity, String message, Throwable throwable) {
		String pluginID = NegocioDiagramEditorPlugin.ID;
	 ...
	 * @generated
	 */
	protected NegocioAbstractExpression(String body, EClassifier context) {
		myBody = body;
		myContext = context;
	}
