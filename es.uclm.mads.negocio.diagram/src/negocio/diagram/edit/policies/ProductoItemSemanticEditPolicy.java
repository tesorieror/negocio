 ...
 * @generated
 */
public class ProductoItemSemanticEditPolicy extends
		NegocioBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ProductoItemSemanticEditPolicy() {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (NegocioVisualIDRegistry.getVisualID(incomingLink) == DocumentoComercialProductoEditPart.VISUAL_ID) {
