 ...
 * @generated
 */
public class ValorDirectoItemSemanticEditPolicy extends
		NegocioBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ValorDirectoItemSemanticEditPolicy() {
		super(NegocioElementTypes.ValorDirecto_2004);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (NegocioVisualIDRegistry.getVisualID(incomingLink) == PagoEditPart.VISUAL_ID) {
