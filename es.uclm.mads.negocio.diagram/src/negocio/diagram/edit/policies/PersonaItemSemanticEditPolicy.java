 ...
 * @generated
 */
public class PersonaItemSemanticEditPolicy extends
		NegocioBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public PersonaItemSemanticEditPolicy() {
		super(NegocioElementTypes.Persona_2002);
	}
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (NegocioVisualIDRegistry.getVisualID(incomingLink) == DocumentoComercialPersonasEditPart.VISUAL_ID) {
