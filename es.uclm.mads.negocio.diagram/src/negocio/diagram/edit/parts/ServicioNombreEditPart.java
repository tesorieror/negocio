 ...
 * @generated
 */
public class ServicioNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ServicioNombreEditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.ServicioNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
