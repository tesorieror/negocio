 ...
 * @generated
 */
public class AtributoSimpleNombreTipoCardinalidadEditPart extends
	 ...
	 * @generated
	 */
	public AtributoSimpleNombreTipoCardinalidadEditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.AtributoSimpleNombreTipoCardinalidadEditPart.VISUAL_ID));
		}
		return parser;
	}
