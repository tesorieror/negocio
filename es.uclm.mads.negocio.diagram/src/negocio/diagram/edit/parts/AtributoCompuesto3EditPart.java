...
import negocio.diagram.edit.policies.AtributoCompuesto3ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class AtributoCompuesto3EditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public AtributoCompuesto3EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AtributoCompuesto3ItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AtributoCompuestoNombreCardinalidad3EditPart) {
			((AtributoCompuestoNombreCardinalidad3EditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureAtributoCompuestoNombreFigure());
			return true;
		}
		if (childEditPart instanceof AtributoCompuestoAtributoCompuestoCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureAtributoCompuestoCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AtributoCompuestoAtributoCompuestoCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AtributoCompuestoAtributoCompuestoCompartment2EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureAtributoCompuestoCompartmentRectangle();
			pane.remove(((AtributoCompuestoAtributoCompuestoCompartment2EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AtributoCompuestoAtributoCompuestoCompartment2EditPart) {
