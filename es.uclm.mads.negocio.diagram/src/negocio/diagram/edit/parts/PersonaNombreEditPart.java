 ...
 * @generated
 */
public class PersonaNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public PersonaNombreEditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.PersonaNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
