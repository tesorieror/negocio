 ...
 * @generated
 */
public class AtributoCompuestoNombreCardinalidad2EditPart extends
	 ...
	 * @generated
	 */
	public AtributoCompuestoNombreCardinalidad2EditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.AtributoCompuestoNombreCardinalidad2EditPart.VISUAL_ID));
		}
		return parser;
	}
