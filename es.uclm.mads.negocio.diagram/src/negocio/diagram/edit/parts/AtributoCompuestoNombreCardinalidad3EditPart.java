 ...
 * @generated
 */
public class AtributoCompuestoNombreCardinalidad3EditPart extends
	 ...
	 * @generated
	 */
	public AtributoCompuestoNombreCardinalidad3EditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.AtributoCompuestoNombreCardinalidad3EditPart.VISUAL_ID));
		}
		return parser;
	}
