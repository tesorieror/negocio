 ...
 * @generated
 */
public class ValorIndirectoNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ValorIndirectoNombreEditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.ValorIndirectoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
