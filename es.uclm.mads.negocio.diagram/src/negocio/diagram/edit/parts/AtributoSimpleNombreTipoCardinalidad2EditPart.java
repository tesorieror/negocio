 ...
 * @generated
 */
public class AtributoSimpleNombreTipoCardinalidad2EditPart extends
	 ...
	 * @generated
	 */
	public AtributoSimpleNombreTipoCardinalidad2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new NegocioTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return NegocioElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = NegocioParserProvider
					.getParser(
							NegocioElementTypes.AtributoSimple_3002,
							getParserElement(),
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.AtributoSimpleNombreTipoCardinalidad2EditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					NegocioEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
