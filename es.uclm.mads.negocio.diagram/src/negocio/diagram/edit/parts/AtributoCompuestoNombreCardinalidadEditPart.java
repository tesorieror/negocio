 ...
 * @generated
 */
public class AtributoCompuestoNombreCardinalidadEditPart extends
	 ...
	 * @generated
	 */
	public AtributoCompuestoNombreCardinalidadEditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.AtributoCompuestoNombreCardinalidadEditPart.VISUAL_ID));
		}
		return parser;
	}
