 ...
 * @generated
 */
public class DocumentoComercialNombreEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public DocumentoComercialNombreEditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.DocumentoComercialNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
