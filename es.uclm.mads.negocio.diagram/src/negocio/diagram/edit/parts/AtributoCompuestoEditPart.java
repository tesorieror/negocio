...
import negocio.diagram.edit.policies.AtributoCompuestoItemSemanticEditPolicy;
...
public class AtributoCompuestoEditPart extends ShapeNodeEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AtributoCompuestoItemSemanticEditPolicy());
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof AtributoCompuestoNombreCardinalidadEditPart) {
			((AtributoCompuestoNombreCardinalidadEditPart) childEditPart)
					.setLabel(getPrimaryShape()
							.getFigureAtributoCompuestoNombreFigure());
			return true;
		}
		if (childEditPart instanceof AtributoCompuestoAtributoCompuestoCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureAtributoCompuestoCompartmentRectangle();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((AtributoCompuestoAtributoCompuestoCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof AtributoCompuestoAtributoCompuestoCompartment3EditPart) {
			IFigure pane = getPrimaryShape()
					.getFigureAtributoCompuestoCompartmentRectangle();
			pane.remove(((AtributoCompuestoAtributoCompuestoCompartment3EditPart) childEditPart)
					.getFigure());
			return true;
		}
		return false;
	...
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof AtributoCompuestoAtributoCompuestoCompartment3EditPart) {
