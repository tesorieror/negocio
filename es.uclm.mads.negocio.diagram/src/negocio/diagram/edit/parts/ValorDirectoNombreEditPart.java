 ...
 * @generated
 */
public class ValorDirectoNombreEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ValorDirectoNombreEditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.ValorDirectoNombreEditPart.VISUAL_ID));
		}
		return parser;
	}
