 ...
 * @generated
 */
public class AtributoSimpleNombreTipoCardinalidad3EditPart extends
	 ...
	 * @generated
	 */
	public AtributoSimpleNombreTipoCardinalidad3EditPart(View view) {
		super(view);
	}
			...
			parser = NegocioParserProvider
					.getParser(
							...
							NegocioVisualIDRegistry
									.getType(negocio.diagram.edit.parts.AtributoSimpleNombreTipoCardinalidad3EditPart.VISUAL_ID));
		}
		return parser;
	}
