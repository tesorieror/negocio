...
import negocio.diagram.part.NegocioDiagramEditorUtil;
 ...
 * @generated
 */
public class NegocioMarkerNavigationProvider extends
		AbstractModelMarkerNavigationProvider {

	/**
	 * @generated
	 */
	public static final String MARKER_TYPE = NegocioDiagramEditorPlugin.ID
	...
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			NegocioDiagramEditorUtil.selectElementsInDiagram(editor,
