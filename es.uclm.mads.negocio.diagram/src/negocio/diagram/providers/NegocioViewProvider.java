 ...
 * @generated
 */
public class NegocioViewProvider extends AbstractProvider implements
		IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return NegocioEditPart.MODEL_ID.equals(op.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = NegocioVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = NegocioVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!NegocioElementTypes.isKnownElementType(elementType)
		...
		return AtributoSimpleEditPart.VISUAL_ID == visualID
				|| PersonaEditPart.VISUAL_ID == visualID
				|| AtributoCompuestoEditPart.VISUAL_ID == visualID
				|| ValorDirectoEditPart.VISUAL_ID == visualID
				|| ServicioEditPart.VISUAL_ID == visualID
				|| ProductoEditPart.VISUAL_ID == visualID
				|| DocumentoComercialEditPart.VISUAL_ID == visualID
				|| ValorIndirectoEditPart.VISUAL_ID == visualID
				|| AtributoCompuesto2EditPart.VISUAL_ID == visualID
				|| AtributoSimple2EditPart.VISUAL_ID == visualID
				|| AtributoCompuesto3EditPart.VISUAL_ID == visualID
				|| AtributoSimple3EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = NegocioVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != NegocioVisualIDRegistry
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(NegocioEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = NegocioVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = NegocioVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case AtributoSimpleEditPart.VISUAL_ID:
			return createAtributoSimple_2001(domainElement, containerView,
					index, persisted, preferencesHint);
		case PersonaEditPart.VISUAL_ID:
			return createPersona_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case AtributoCompuestoEditPart.VISUAL_ID:
			return createAtributoCompuesto_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case ValorDirectoEditPart.VISUAL_ID:
			return createValorDirecto_2004(domainElement, containerView, index,
					persisted, preferencesHint);
		case ServicioEditPart.VISUAL_ID:
			return createServicio_2005(domainElement, containerView, index,
					persisted, preferencesHint);
		case ProductoEditPart.VISUAL_ID:
			return createProducto_2006(domainElement, containerView, index,
					persisted, preferencesHint);
		case DocumentoComercialEditPart.VISUAL_ID:
			return createDocumentoComercial_2007(domainElement, containerView,
					index, persisted, preferencesHint);
		case ValorIndirectoEditPart.VISUAL_ID:
			return createValorIndirecto_2008(domainElement, containerView,
					index, persisted, preferencesHint);
		case AtributoCompuesto2EditPart.VISUAL_ID:
			return createAtributoCompuesto_3001(domainElement, containerView,
					index, persisted, preferencesHint);
		case AtributoSimple2EditPart.VISUAL_ID:
			return createAtributoSimple_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case AtributoCompuesto3EditPart.VISUAL_ID:
			return createAtributoCompuesto_3003(domainElement, containerView,
					index, persisted, preferencesHint);
		case AtributoSimple3EditPart.VISUAL_ID:
			return createAtributoSimple_3004(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (NegocioVisualIDRegistry.getVisualID(elementTypeHint)) {
		case DocumentoComercialProductoEditPart.VISUAL_ID:
			return createDocumentoComercialProducto_4001(containerView, index,
					persisted, preferencesHint);
		case ValorIndirectoJustificanteEditPart.VISUAL_ID:
			return createValorIndirectoJustificante_4002(containerView, index,
					persisted, preferencesHint);
		case DocumentoComercialPersonasEditPart.VISUAL_ID:
			return createDocumentoComercialPersonas_4003(containerView, index,
					persisted, preferencesHint);
		case PagoEditPart.VISUAL_ID:
			return createPago_4004(getSemanticElement(semanticAdapter),
	 ...
	 * @generated
	 */
	public Node createAtributoSimple_2001(EObject domainElement,
		...
		node.setType(NegocioVisualIDRegistry
	 ...
	 * @generated
	 */
	public Node createPersona_2002(EObject domainElement, View containerView,
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(NegocioVisualIDRegistry.getType(PersonaEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createAtributoCompuesto_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createValorDirecto_2004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createServicio_2005(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(NegocioVisualIDRegistry
				.getType(ServicioEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createProducto_2006(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
				.add(NotationFactory.eINSTANCE.createDescriptionStyle());
		...
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(NegocioVisualIDRegistry
				.getType(ProductoEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
	 ...
	 * @generated
	 */
	public Node createDocumentoComercial_2007(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createValorIndirecto_2008(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createAtributoCompuesto_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createAtributoSimple_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createAtributoCompuesto_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Node createAtributoSimple_3004(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.getStyles()
	 ...
	 * @generated
	 */
	public Edge createDocumentoComercialProducto_4001(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		edge.setType(NegocioVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createValorIndirectoJustificante_4002(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createDocumentoComercialPersonas_4003(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
	 ...
	 * @generated
	 */
	public Edge createPago_4004(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Edge edge = NotationFactory.eINSTANCE.createEdge();
		edge.getStyles().add(NotationFactory.eINSTANCE.createRoutingStyle());
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(NegocioVisualIDRegistry.getType(PagoEditPart.VISUAL_ID));
	...
	private void stampShortcut(View containerView, Node target) {
		if (!NegocioEditPart.MODEL_ID.equals(NegocioVisualIDRegistry
			...
			shortcutAnnotation.getDetails().put(
					"modelID", NegocioEditPart.MODEL_ID); //$NON-NLS-1$
